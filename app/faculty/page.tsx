...
// ── Faculty Questions Tab (Admin-Style Dashboard) ────────────
function FacultyQuestionsTab({ branches }: { branches: string[] }) {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      // Filter to faculty's assigned branches
      const filtered = qData.filter(q => branches.includes(q.branch));
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.main}>
        ...
        {tab === "questions" && (
          <FacultyQuestionsTab branches={profile.branches} />
        )}
